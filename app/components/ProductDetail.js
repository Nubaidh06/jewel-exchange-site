      ...
      <div className="product-detail-split">
        ...
        <div className="product-info-wrapper">
          <div className="product-info">
            ...
            {/* Ornament Divider */}
            <div className="ornament product-info__ornament reveal reveal-delay-2">
            ...
            {/* ── Action Buttons ── */}
            <div className="product-info__actions reveal reveal-delay-3" ref={actionsRef}>
              <a
                href={whatsappUrl}
                target="_blank"
                rel="noopener noreferrer"
                className="btn btn--full product-info__btn product-info__btn--whatsapp"
              >
